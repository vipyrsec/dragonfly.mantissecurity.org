...
async def find_package_source_download_url(
    http_session: aiohttp.ClientSession, package_title: str
) -> str | None:
...
def search_contents(rules, files: dict[str, str]) -> list[tuple[str, "yara matches"]]:
